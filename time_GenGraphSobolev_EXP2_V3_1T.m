...
for idSS = 1:nSS
    ...
    DD_SS_II = Compute_GST_EXP2_vec_V3(tmpAbsDD_mat, wwGG_TR_mat);
...
outName = [dsName '_Time_GenSobolevExp2_V3_' num2str(maxKC) '_' typeGG '_' num2str(nPair) '_S' num2str(nSS) '.mat'];
